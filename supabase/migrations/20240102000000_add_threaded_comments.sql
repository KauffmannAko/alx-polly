-- Add threaded discussion support to comments table
...
-- Update RLS policies for threaded comments
-- Users can view their own comments even if not approved (for editing)
...
-- Success message
SELECT 'Threaded comments support added successfully!' AS message;